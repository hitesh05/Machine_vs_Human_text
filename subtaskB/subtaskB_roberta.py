...
mono_train_data = pd.read_json('../SemEval8/SubtaskB/subtaskB_train.jsonl', lines=True)
# mono_train_data = mono_train_data.sample(n=10000)
mono_dev_data = pd.read_json('../SemEval8/SubtaskB/subtaskB_dev.jsonl', lines=True)
