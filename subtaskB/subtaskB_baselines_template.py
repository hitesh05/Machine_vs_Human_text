...
mono_train_data['text'] = mono_train_data['text'].apply(clean_text)
mono_train_data['text'] = mono_train_data['text'].str.replace('\d+', '')

mono_dev_data['text'] = mono_dev_data['text'].apply(clean_text)
mono_dev_data['text'] = mono_dev_data['text'].str.replace('\d+', '')
